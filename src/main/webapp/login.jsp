    ...
    <section class="container flex-container justify-center align-center" style="min-height: 70vh;">
        <div class="card" style="max-width: 420px; width: 100%;">
            ...
            <% if(request.getAttribute("mensaje") != null) { %>
                <div style="background-color: #ffcccc; color: #333; padding: 10px; border-radius: 5px; text-align: center; margin-bottom: 10px;">
                    <%= request.getAttribute("mensaje") %>
                </div>
            <% } %>

            <form action="<%=request.getContextPath()%>/AutenticarController" method="post">
...
<footer class="footer"><p>Proyecto académico - Sistema de citas veterinarias</p></footer>
